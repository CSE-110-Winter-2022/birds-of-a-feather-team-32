...
public class FavoritesAndSaveSessionsTest {
    ...
    */
    ...
    @Test
    public void favoritesAndSaveSessionsTest() {
        ...
        ViewInteraction frameLayout = onView(
                allOf(withParent(allOf(withId(R.id.student_view),
                        withParent(IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class)))),
                        isDisplayed()));
        frameLayout.check(matches(isDisplayed()));

        ViewInteraction appCompatImageButton = onView(
                allOf(withId(R.id.star_hollow_button),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.student_view),
                                        0),
                                4),
                        isDisplayed()));
        ...
        ViewInteraction materialButton8 = onView(
                allOf(withId(R.id.favoriteButton), withText("View Favorites"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction frameLayout2 = onView(
                allOf(withParent(allOf(withId(R.id.favorite_view),
                        withParent(IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class)))),
                        isDisplayed()));
        ...
        ViewInteraction frameLayout3 = onView(
                allOf(withParent(allOf(withId(R.id.saved_sessions_view),
                        withParent(IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class)))),
                        isDisplayed()));
