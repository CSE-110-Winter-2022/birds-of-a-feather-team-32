...
public class SortingStrategyTests {
    ...
    public void initialize() {
        ...
        Student student1 = new Student(0,0,"Test Student 1", "TESTURL1", 1, "test", false, false);
        Course course1 = new Course(0, 0, "CSE", "110", "2022", "WI", "Small (40–75)");

        Student student2 = new Student(1,0,"Test Student 2", "TESTURL2", 3, "test", false, false);
        ...
        Student student3 = new Student(2,0,"Test Student 3", "TESTURL2", 2, "test", false, false);
        ...
        Student student4 = new Student(3,1,"Test Student 4", "TESTURL1", 1, "test", false, false);
        Course course7 = new Course(6, 3, "CSE", "110", "2021", "FA", "Small (40–75)");

        Student student5 = new Student(4,1,"Test Student 5", "TESTURL2", 3, "test", false, false);
        Course course8 = new Course(7, 4, "CSE", "110", "2021", "SU", "Small");

        Student student6 = new Student(5,1,"Test Student 6", "TESTURL2", 2, "test", false, false);
        Course course9 = new Course(8, 5, "CSE", "110", "2021", "SP", "Small");

        Student student7 = new Student(6,1,"Test Student 7", "TESTURL2", 2, "test", false, false);
